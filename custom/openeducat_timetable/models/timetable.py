...
class OpSession(models.Model):
    ...
    @api.depends('faculty_id', 'subject_id', 'start_datetime','headquarters')
    def _compute_name(self):
        for session in self:
            if session.faculty_id and session.subject_id and session.start_datetime and session.headquarters:
